...
|---|---|---:|---:|---:|---:|
| 示例模块 | [example/](../03-Knowledge/example/knowledge.md) | 1 | 1 | 1 | 72.5 |
| 调度器 | [sched/](../03-Knowledge/sched/knowledge.md) | 0 | 1 | 86 | 70.0 |
...
- `task_struct` (sched, 2026-08-30)

## 开放问题统计

CRITICAL: 0 · MEDIUM: 2 · LOW: 0
